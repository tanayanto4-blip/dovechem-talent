...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PT Dover Chemical — Psikotest Rekrutmen" },
      { name: "description", content: "Platform psikotest & rekrutmen resmi PT Dover Chemical Indonesia. Login kandidat dengan kode akses, dashboard admin HR." },
      { property: "og:title", content: "PT Dover Chemical — Psikotest Rekrutmen" },
      { property: "og:description", content: "Platform psikotest & rekrutmen resmi PT Dover Chemical Indonesia." },
