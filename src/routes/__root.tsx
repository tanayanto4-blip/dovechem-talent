...
import { captureAppError, installErrorMonitor } from "../lib/error-monitor";
  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/f05c91fa-26ee-4714-86a6-921631333f6e/id-preview-cf6a42ed--cdbabcc7-d6e1-4523-b8ff-7d1a8708f581.lovable.app-1784217000306.png",
      },
      {
        name: "twitter:image",
        content:
